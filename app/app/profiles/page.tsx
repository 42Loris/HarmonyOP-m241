      ...
      {profiles.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {profiles.map((profile) => (
            <Card key={profile.id} className="relative overflow-hidden group hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border-slate-200 hover:border-blue-300 h-full flex flex-col">
              ...
              <Link href={`/app/profiles/${profile.id}`} className="block flex-grow cursor-pointer">
                <CardHeader className="pb-4">
                  <div className="flex justify-between items-start mb-2">
                    <Badge variant="secondary" className="bg-slate-100 text-slate-600 group-hover:bg-blue-50 group-hover:text-blue-700 transition-colors">
                      {profile.department}
                    </Badge>
              ...
              <CardContent className="bg-slate-50 border-t p-4 mt-auto transition-colors group-hover:bg-blue-50/30">
                <div className="flex items-center justify-between">
                  ...
                  {profile.entraGroupId ? (
                    <Badge className="bg-green-50 text-green-700 border-green-200 hover:bg-green-100 gap-1 flex items-center">
